...
angular.module('jason.pagination',[]).directive('jasonPagination', [function() {
    return {
        ...
        template: '<div class="page-list" style="min-width:300px;letter-spacing: 1px;">' +
            ...
            '第<input type="text" style="width:30px;line-height:12px;" ng-model="jumpPageNum"  ng-keyup="jumpToPage($event)"/>页 ' +
        ...
        link: function(scope, element, attrs) {
            ...
            function getPagination() {
                ...
                var perPageOptionsLength = scope.conf.perPageOptions && scope.conf.perPageOptions.length;
                // 定义状态
